...
class DeltaPartitionedGraph {
 ...
 public:
  ...
  DeltaPartitionedGraph(const PartitionID k) :
    _k(k),
    _pg(nullptr),
  ...
  HyperedgeWeight moveToPenalty(const HypernodeID u, const PartitionID p) const {
    ...
    return incident_weight_u - incident_weight_p;
  }
 ...
 private:
  ...
  DynamicSparseMap<size_t, HyperedgeWeight> _incident_weight_in_part_delta;
};
