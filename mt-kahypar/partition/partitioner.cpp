...
#include <mt-kahypar/partition/preprocessing/community_detection/natural_cut_detection.h>
...
namespace mt_kahypar {
  ...
  void preprocess(Hypergraph& hypergraph, Context& context) {
    if ( context.preprocessing.use_community_detection ) {
      ...
      ds::Clustering communities = community_detection::run_natural_cut_detection(hypergraph, context);
      hypergraph.setCommunityIDs(std::move(communities));
